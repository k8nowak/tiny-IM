...
txt_files = glob.glob('lesson_contents/*.txt')
...
for file_path in txt_files:
    ...
    # Extract Lesson Headers (ensure it has at least 5 lines)
    lesson_headers = lesson_lines[0:5]
    print(lesson_headers)

    if len(lesson_headers) < 5:
        print(f"Skipping file {file_path}: not enough header lines.")
